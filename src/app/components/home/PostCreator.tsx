...
export default function PostCreator({ user, onPostClick }: PostCreatorProps) {
  return (
    <div className="hidden lg:block bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3 sm:p-4 mb-6 w-full max-w-full overflow-hidden">
